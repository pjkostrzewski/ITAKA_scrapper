...
class Offer(models.Model):
    ...
    old_price = models.IntegerField(validators=[MinValueValidator(0)], blank=True, null=True)
    ...
    @property
    def difference(self):
        return self.old_price - self.current_price

    @property
    def difference_percantage(self):
        division = float(self.difference)/float(self.old_price) * 100
        return int(round(division, 0))
